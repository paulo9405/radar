...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-*2m+!_n44p(jh^uu7z6utxx^80w1*kuwank((u750$_xd_q2+(')
...
# Use DATABASE_URL from environment (Render PostgreSQL) or fallback to SQLite for local dev
...
# Cache configuration
# Simple in-memory cache (sufficient for PKCE code_verifier temporary storage)
# OAuth tokens are now stored in PostgreSQL database, not cache
CACHES = {
    'default': {
